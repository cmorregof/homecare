...
| Agents | OpenAI GPT-6 Astra (`gpt-6-astra`, override with `OPENAI_MODEL`) · prompts informed by CARMEN-I aggregates · Carmen speaks Spanish or English per patient (`/idioma`, Telegram `language_code`) |
